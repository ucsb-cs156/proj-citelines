...
describe("HomePageLoggedIn tests", () => {
  ...
  test("researcher sees both sections, with owned projects empty message", async () => {
    axiosMock
      .onGet("/api/currentUser")
  ...
  test("researcher sees their owned projects when there are some", async () => {
    axiosMock
      .onGet("/api/currentUser")
      .reply(200, apiCurrentUserFixtures.researcherUser);
    axiosMock
  ...
  test("researcher can create a new project", async () => {
    axiosMock
      .onGet("/api/currentUser")
      .reply(200, apiCurrentUserFixtures.researcherUser);
    axiosMock
